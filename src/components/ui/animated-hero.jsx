        ...
        <div
          ...
          <div className="flex gap-4 flex-col">
            ...
            <p
              ...
              Grab exclusive coupons and save big on your favorite brands. Just one click to claim—no hassle, just rewards!"
            </p>
          </div>
          <div className="flex flex-row gap-3">
            <Link href="/">
            <Button size="lg" className="gap-4">
              Just accept the cookies <MoveRight className="w-4 h-4" />
            </Button>
            </Link>
          </div>
        </div>
